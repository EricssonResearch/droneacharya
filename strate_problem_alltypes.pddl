...
(:init
    ...
    (at 3000 (not (active station-13-image)))
    (at 3000 (not (active station-13-inventory-mapping)))
    (at 3000 (not (active station-13-signal-measurement)))
    (at 3000 (not (active station-13-thermal-image)))
    (at 3000 (not (active station-14-image)))
    (at 3000 (not (active station-14-inventory-mapping)))
    (at 3000 (not (active station-14-signal-measurement)))
    (at 3000 (not (active station-14-thermal-image)))
    (at 3000 (not (active station-15-image)))
    (at 3000 (not (active station-15-inventory-mapping)))
    (at 3000 (not (active station-15-signal-measurement)))
    (at 3000 (not (active station-15-thermal-image)))
