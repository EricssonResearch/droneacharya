...
(define (problem asi-dur-problem-3site)
  (:domain asi-dur-domain-3site)
 
 ;; charging-docks-1 and -2, not associated with any tower.
 ; 3 sites
  (:objects 
  ...
  third-tower-launchpad s3-antenna-1 s3-antenna-2 s3-antenna-3 s3-antenna-4 s3-antenna-5 s3-antenna-6 - component 
  ...
  (:init
    ...
    (= (distance first-tower-launchpad third-tower-launchpad) 120)
    (= (distance third-tower-launchpad first-tower-launchpad) 120)

    (= (distance second-tower-launchpad third-tower-launchpad) 90)
    (= (distance third-tower-launchpad second-tower-launchpad) 90)
    ...
    (= (distance first-tower-launchpad charging-dock-2) 150)
    (= (distance second-tower-launchpad charging-dock-2) 80)
    (= (distance charging-dock-2 first-tower-launchpad) 150)
    (= (distance charging-dock-2 second-tower-launchpad) 80)

    (= (distance third-tower-launchpad charging-dock-1) 80)
    (= (distance third-tower-launchpad charging-dock-2) 40)
    (= (distance charging-dock-1 third-tower-launchpad) 80)
    (= (distance charging-dock-2 third-tower-launchpad) 40)
    ...
    ;2nd charging-dock
    (is-perspective launch-pad-1 charging-dock-2)
    (is-perspective launch-pad-2 charging-dock-2)
    (is-perspective launch-pad-3 charging-dock-2)
    (is-perspective launch-pad-4 charging-dock-2)

    (is-charging-dock charging-dock-2 launch-pad-1)
    (is-charging-dock charging-dock-2 launch-pad-2)
    (is-charging-dock charging-dock-2 launch-pad-3)
    (is-charging-dock charging-dock-2 launch-pad-4)

    (is-clear-perspective launch-pad-1 charging-dock-2)
    (is-clear-perspective launch-pad-2 charging-dock-2)
    (is-clear-perspective launch-pad-3 charging-dock-2)
    (is-clear-perspective launch-pad-4 charging-dock-2)
    ...
    (is-perspective launch-pad-4 second-tower-launchpad)
    ...
    (not (is-clear-perspective launch-pad-4 first-tower-launchpad)) ;; CHECK this
    ;AM: distances to single launchpad - not associated with any of the towers
    ...
    (is-perspective launch-pad-1 third-tower-launchpad)
    (is-perspective launch-pad-2 third-tower-launchpad)
    (is-perspective launch-pad-3 third-tower-launchpad)
    (is-perspective launch-pad-4 third-tower-launchpad)
    (is-clear-perspective launch-pad-1 third-tower-launchpad)
    (is-clear-perspective launch-pad-2 third-tower-launchpad)
    (is-clear-perspective launch-pad-3 third-tower-launchpad)
    (is-clear-perspective launch-pad-4 third-tower-launchpad)
    ; (not (is-clear-perspective launch-pad-4 first-tower-launchpad)) ;; CHECK this
    (= (distance third-tower-launchpad s3-antenna-1) 29)
    (= (distance third-tower-launchpad s3-antenna-2) 29)
    (= (distance third-tower-launchpad s3-antenna-3) 30)
    (= (distance third-tower-launchpad s3-antenna-4) 30)
    (= (distance third-tower-launchpad s3-antenna-5) 29)
    (= (distance third-tower-launchpad s3-antenna-6) 29)
    ...
    (= (distance s3-antenna-1 second-tower-launchpad) 29)
    ...
    ; (is-clear-perspective right s2-antenna-2)
    ; (is-clear-perspective front-below s2-antenna-2)
    (= (distance s3-antenna-2 third-tower-launchpad) 29)
    ...
    ; (is-clear-perspective right s2-antenna-3)
    ; (is-clear-perspective front-below s2-antenna-3)
    (= (distance s3-antenna-3 third-tower-launchpad) 30)
    ...
    ; (is-clear-perspective right s2-antenna-4)
    ; (is-clear-perspective front-below s2-antenna-4)
    (= (distance s3-antenna-4 third-tower-launchpad) 30)
    ...
    ; (is-clear-perspective right s2-antenna-5)
    ; (is-clear-perspective front-below s2-antenna-5)
    (= (distance s3-antenna-5 third-tower-launchpad) 29)
    ...
    ; (is-clear-perspective right s2-antenna-6)
    ; (is-clear-perspective front-below s2-antenna-6)
    (= (distance s3-antenna-6 third-tower-launchpad) 29)
  ...
  (:goal (and
      ...
      ; (is-at drone3 second-tower-launchpad launch-pad-1)
      ; (is-at drone4 third-tower-launchpad launch-pad-1)
